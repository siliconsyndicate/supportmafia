...
func (s *Server) StartServer() {
	...
	gothic.Store = store
	goth.UseProviders(
		google.New(s.API.Config.GoogleOAuth.ClientID, s.API.Config.GoogleOAuth.ClientSecret, "https://2dd3-114-143-3-90.ngrok-free.app/auth/google/callback", "email", "profile"),
	)
	n := negroni.New()
